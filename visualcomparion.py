...
def create_comparison_image(image_paths_list, method_names, output_path,
                            ...
                            method_name_spacing=38,  line_height_increase=20):
# def create_comparison_image(image_paths_list, method_names, output_path,
...
#                             method_name_spacing=60, line_height_increase=0):
    ...
    font_size = int(max_width / (2304 / 28))  # 计算字体大小
...
method_file = '../config/article1/compare/copmaremethod.json'
...
dataset_file = '../config/article1/compare/dataset.json'
...
imglist_file = '../config/article1/compare/selected_images.json'
# 加载配置文件
...
output_path = '../result/article1/visualcompare128/comparison128.png'  #这是文章1的画图
